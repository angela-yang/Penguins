# Bear Go Brr 🏆 *3rd Place Winner of EMP Hackfest 2024*
## What It Does
...
1. Clone our project onto your own computer (enter this in your terminal):

```bash
git clone https://github.com/angela-yang/Penguins.git
```
...
3. Open [http://localhost:8056](http://localhost:8056) with your browser to see the result.
...
Check out our [Devpost submission](https://devpost.com/software/bear-go-brrr) for more details!
